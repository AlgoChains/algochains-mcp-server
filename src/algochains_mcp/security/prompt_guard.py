...
false positives that trip skill circuit breakers (bot-health, adaptive-brain,
crew-orchestrator, slack-command-listener, output-auditor, fat-finger-protection,
crew-handoff-router, agent-knowledge-graph).
...
# Extra markers for operator system prompts (bot-health, agent-knowledge-graph, graphiti).
