...
def _default_control_tower() -> str:
    ...
    Keep this wrapper for older tests/monkeypatches, but delegate to the shared
    resolver so all MCP tools honor the same Mac, desktop, WSL, env-var, and
    sibling-checkout fallback order.
    """
