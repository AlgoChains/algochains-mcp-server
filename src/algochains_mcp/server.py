...
def _default_control_tower() -> str:
    ...
    `server.py` has several tower health/status readers; keeping this wrapper
    lets older tests monkeypatch `_default_control_tower` while avoiding a
    second, stale fallback list here.
    """
