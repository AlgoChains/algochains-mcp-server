...
def _default_control_tower() -> str:
    ...
    Keep this wrapper because several tests and call sites monkeypatch it, but
    delegate the actual path selection to ``paths.default_control_tower`` so MCP
    tools share the same Mac/Linux/WSL fallback order as the rest of the package.
    """
