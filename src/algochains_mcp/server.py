...
TOOLS = [
    ...
    Tool(name="bracket_integrity_check",
         description="Verify every open non-MNQ position has BOTH stop AND target working orders live at Tradovate. MNQ OSO brackets are excluded. Returns checked_count, incomplete positions, and a summary line for BRACKET-INTEGRITY-MONITOR. Status OK | INCOMPLETE_BRACKETS | DEGRADED (state/broker mismatch) | ERROR.",
         inputSchema={"type": "object", "properties": {}, "required": []},
         annotations=ANNOT_READ_ONLY),
