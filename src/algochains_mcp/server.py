...
def _default_control_tower() -> str:
    ...
    Keep this wrapper for older tests and monkeypatches, but delegate to
    ``paths.default_control_tower`` so server tools honor the same Mac, desktop,
    WSL, and sibling fallback list as the rest of the package.
    """
