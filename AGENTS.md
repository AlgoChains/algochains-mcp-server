...
| **Marketplace** | `get_marketplace_listings`, `submit_to_marketplace`, `run_marketplace_autopilot`, `run_mcpt_pipeline` | Strategy publishing and decay tracking. Staging artifacts must pass Django VirusTotal hash lookup (5 scans/person/day). |
